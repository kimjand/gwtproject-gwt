...
/**
 * Localized names for the "xnr" locale.
 */
public class LocalizedNamesImpl_xnr extends LocalizedNamesImpl {
  ...
  protected void loadNameMapJava() {
    ...
    namesMap.put("419", "लैटिन अमरिका");
    namesMap.put("AC", "असेंशन द्वीप");
    namesMap.put("AD", "एंडोरा");
    namesMap.put("AE", "कट्ठा अरब अमीरात");
    namesMap.put("AF", "अफ़गानिस्तान");
    namesMap.put("AG", "एंटिगुआ कने बरबुडा");
    ...
    namesMap.put("AX", "एलैंड द्वीपां दा झुंड");
    ...
    namesMap.put("CA", "कनेडा");
    namesMap.put("CC", "कोकोस (कीलिंग) द्वीपां दा झुंड");
    namesMap.put("CD", "कांगो - किंशासा");
    namesMap.put("CF", "बिचला अफ़्रीकी गणराज्य");
    namesMap.put("CG", "कांगो – ब्राज़ाविल");
    namesMap.put("CH", "स्विट्ज़रलैंड");
    namesMap.put("CI", "कोट डी आइवर");
    namesMap.put("CK", "कुक द्वीपां दा झुंड");
    ...
    namesMap.put("FK", "फ़ॉकलैंड द्वीपां दा झुंड");
    namesMap.put("FM", "माइक्रोनेशिया");
    namesMap.put("FO", "फ़ेरो द्वीपां दा झुंड");
    ...
    namesMap.put("KN", "सेंट किट्स कने नेविस");
    namesMap.put("KP", "उत्तर कोरिया");
    namesMap.put("KR", "दखण कोरिया");
    ...
    namesMap.put("MH", "मार्शल द्वीपां दा झुंड");
    namesMap.put("MK", "उत्तरी मकदूनिया");
    namesMap.put("ML", "माली");
    namesMap.put("MM", "म्यांमार (बर्मा)");
    namesMap.put("MN", "मंगोलिया");
    namesMap.put("MO", "मकाऊ (खास प्रशासनिक लाका चीन)");
    namesMap.put("MP", "उत्तरी मारियाना द्वीपां दा झुंड");
    ...
    namesMap.put("PS", "फ़िलिस्तीनी लाका");
    ...
    namesMap.put("TC", "तुर्क कने कैकोज़ द्वीपां दा झुंड");
    namesMap.put("TD", "चाड");
    namesMap.put("TF", "फ़्रांसीसी दखणे बखें लाका");
    ...
    namesMap.put("UM", "यू॰एस॰ आउटलाइंग द्वीपां दा झुंड");
    namesMap.put("UN", "संयुक्त रास्टर");
    namesMap.put("US", "कट्ठा राज्य");
    ...
    namesMap.put("VG", "ब्रिटिश वर्जिन द्वीपां दा झुंड");
    namesMap.put("VI", "यू॰एस॰ वर्जिन द्वीपां दा झुंड");
    ...
    namesMap.put("ZA", "दखण अफ़्रीका");
    namesMap.put("ZM", "ज़ाम्बिया");
    namesMap.put("ZW", "ज़िम्बाब्वे");
    namesMap.put("ZZ", "अणजाण लाका");
  }
