...
/**
 * Localized names for the "trw" locale.
 */
public class LocalizedNamesImpl_trw extends LocalizedNamesImpl {
  ...
  protected void loadNameMapJava() {
    ...
    namesMap.put("018", "جنوبی افریقہ سی علاقہ");
    namesMap.put("019", "امیریکاز");
    namesMap.put("021", "شمالی امریکہ سی علاقہ");
    ...
    namesMap.put("EA", "سیئوٹا آں میلیلا");
    ...
    namesMap.put("GS", "جنوبی جارجیا آں جنوبی سینڈوچ جزائر");
    ...
    namesMap.put("IO", "برطانوی بحر ہند سی علاقہ");
    ...
    namesMap.put("PM", "سینٹ پیئر آں میکلیئون");
    ...
    namesMap.put("SJ", "سوالبرڈ آں جان ماین");
    ...
    namesMap.put("VC", "سینٹ ونسنٹ آں گرینیڈائنز");
    ...
    namesMap.put("WF", "ویلیز آں فیوٹیونا");
    namesMap.put("WS", "ساموآ");
    namesMap.put("XA", "بناوٹی لہجے");
    namesMap.put("XB", "مصنوعی بیڑی");
