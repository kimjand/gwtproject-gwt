...
public class LocalizedNamesImpl_ca extends LocalizedNamesImpl {
  ...
  protected void loadNameMapJava() {
    ...
    namesMap.put("CC", "Illes Cocos (Keeling)");
    ...
    namesMap.put("HM", "Illes Heard i McDonald");
